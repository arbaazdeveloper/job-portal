...
const Inputs = ({value,hasError,text,placeholder,error,onChange,name,extraStyle}) => {
    ...
    return (
    <>
            <input name={name} id={text} className={`${inputStyle} ${extraStyle} ${hasError?'border-error-color':''}`} placeholder={placeholder} value={value}  onChange={onChange} />
