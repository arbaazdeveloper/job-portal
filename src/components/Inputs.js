...
const Inputs = ({value,hasError,text,placeholder,error,onChange,name,style}) => {
    ...
    return (
    <>
            <input name={name} id={text} className={`${inputStyle} ${style} ${hasError?'border-error-color':''}`} placeholder={placeholder} value={value}  onChange={onChange} />
